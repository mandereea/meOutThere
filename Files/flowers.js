export const flowers = [
    ...
    },
    {
        ...
        temperament: ['Cool and Dry', [-1, -1]],
        history:['5000 years ago was being cultivated as medicinal herb and vegetable crop in ancient Egypt','Known as "Friend of the Liver" in ancient Europe', ''],
        dayFact:[''],
        description:{
            taste:['Bitter', 'B '],
